...
namespace ORM
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Akce novaAkce = new Akce(SelectAkce.Count()+1, "Nova Akce z Csharp", datum, 0, vdm.SelectById(1), hdm.SelectById(1), 40);
            ...
            //4.2 - moznost je naimplementovana, ale neni urcena k pouziti
            //fdm.Delete(SelectFunkce[SelectFunkce.Count()-1]);
            ...
            */
            ...
            //sdm.Save(novaSchuzka);

            //5.2 - moznost je naimplementovana, ale neni urcena k pouziti
            //sdm.Delete(novaSchuzka);
            ...
            //hdm.Save(NovaHodnost);

            //7.2
            //hdm.Delete(NovaHodnost);
